...
const rolls = {
	...
	"Sleight Of Hand":		roll.createEntry(	"Skill",		"1D20+{DEX}+{PB}",						"",							specs),
	"Stealth":				roll.createEntry(	"Skill",		"1D20+{DEX}", 							"",							specs),
	...
	"Attack":				roll.createEntry(	"CondAdv",		"1D20+5",								"Pact Tactics",				specs),
	"Bite":					roll.createEntry(	"Generic",		"1D8+3",								"",							specs),	
	"Raging Bite":			roll.createEntry(	"Generic",		"1D8+3+{RAGE}",							"",							specs),	
	"Trip":					roll.createEntry(	"Note",			"DC13 STR or knocked prone",			"",							specs),	
	
	"Bite Attack":			roll.createMulti(	["Attack", "Bite", "Trip"] ),
	"Raging Bite Attack":	roll.createMulti(	["Attack", "Raging Bite", "Trip"] ),
